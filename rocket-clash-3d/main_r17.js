...
function LoadScript(e,t) {
	if(e.indexOf('addthis_widget') == -1){
		var n,a=document.createElement("script");a.setAttribute("src",e),a.onreadystatechange=a.onload=function(){n||(n=!0,t&&t())},document.getElementsByTagName("head")[0].appendChild(a)
	}
}
...
const gamemodule_file = DEV_VERSION ? '/embed/farm_dev/index.js' + NOCACHE : (!REVISION ? "index.js?v=5" : "index_r" + REVISION.module + ".js?v=8");
...
var config_url = 'clash3d/config/' + GAME_ID + '.required';
if (DEV_VERSION)
    config_url += '?dev=1';
